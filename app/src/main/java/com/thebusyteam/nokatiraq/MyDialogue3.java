...
public class MyDialogue3 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lay_img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra(Intent.EXTRA_STREAM, Uri.parse(TextCollection.save(getContentResolver())));
        ...
        lay_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                in.putExtra(Intent.EXTRA_TEXT, TextCollection.adapter.getItem(TextCollection.start3-1).toString());
                startActivity(Intent.createChooser(in, "Share"));
                finish();
            }
        });
